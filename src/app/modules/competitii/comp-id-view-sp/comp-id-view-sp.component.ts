...
@Component({
  selector: 'app-comp-id-view-sp',
  templateUrl: './comp-id-view-sp.component.html',
  styleUrls: ['./comp-id-view-sp.component.scss']
})
export class CompIdViewSpComponent  implements OnInit {
  hasToken = false;
  descrierea = false;
